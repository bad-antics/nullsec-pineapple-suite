...
# ─── External adapter reminder ─────────────────────────────────
echo ""
echo "────────────────────────────────────────────────"
echo " Heads up: the pager has NO internal recon radio."
echo " All recon / attack / audit payloads need an"
echo " external USB adapter (MK7AC is the supported"
echo " one). Plug it in and it will usually enumerate"
echo " as wlan1 — the payloads autodetect it now via"
echo " lib/nullsec-iface.sh. If scans return zero"
echo " results, run on the pager:"
echo ""
echo "   ip link show ; iw dev ; lsusb"
echo ""
echo " to confirm the adapter is present."
echo "────────────────────────────────────────────────"
